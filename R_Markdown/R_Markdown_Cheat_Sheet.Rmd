...
green_text<-format_with_col("want to print this in green", "green")
``` 
`r red_text` regular black text `r green_text`   
...
![](C:\coursera\myDocs\Data-Science-Cheat-Sheets\R_Markdown\image1.PNG)
...
[R markdown refference](https://www.rstudio.com/wp-content/uploads/2015/03/rmarkdown-reference.pdf)  
